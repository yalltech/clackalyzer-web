      ...
      <section className="py-16 md:py-24">
        <div className="container-max max-w-2xl text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-ck-teal text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-ck-teal/85 transition"
          >
          ...
          <p className="text-ck-grid text-sm mt-6">
            Already on Discord? Say hi in <span className="text-ck-text font-medium">#beta-testers</span>.
          </p>
